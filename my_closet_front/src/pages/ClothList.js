...
const ClothList = () => {
  ...
  const show = () => {
    ...
    cloth.post('/clothes/byCategory', null,{params: {
        category: firstCategory.toString(), subcategory: secondCategory.toString(),
      ...
      <>
        ...
        <div style={{textAlign:'center'}}>
          ...
          {clothList && clothList.map((obj) => (
              <ClothInfo name={obj.name} photo={obj.photo} category={obj.category}
                         subcategory={obj.subcategory} filter={obj.filter}/>
          ))}
          <div>
